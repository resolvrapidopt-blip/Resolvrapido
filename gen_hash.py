...
def main():
    ...
    print()
    print("Copie os valores abaixo para os Secrets do seu ambiente de deploy:")
    print()
    ...
    print()
    print("Guarde a senha em local seguro — ela NÃO pode ser recuperada a partir do hash.")
