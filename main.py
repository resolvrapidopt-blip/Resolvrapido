...
def main() -> None:
    ...
    st.set_page_config(page_title="ResolvRapido Brasil v18.0.0", page_icon="🏛", layout="wide")
    init_db()
    ensure_demo_account()
    ...
    if pagina_ativa == "dashboard":
        pagina_dashboard()
    elif pagina_ativa == "efd":
        pagina_efd()
    elif pagina_ativa == "analise_completa":
        pagina_analise_completa()
    elif pagina_ativa == "calculos":
        pagina_calculos()
    elif pagina_ativa == "ledger":
        pagina_ledger()
    elif pagina_ativa == "legislacao":
        pagina_legislacao()
    elif pagina_ativa == "auditor_pack":
        pagina_auditor_pack()
    elif pagina_ativa == "dossie_v11":
        pagina_dossie_v11()
    elif pagina_ativa == "patch_v12":
        try:
            pagina_patch_v12()
        except NameError:
            st.warning("Patch v12 indisponível neste build.")
    elif pagina_ativa == "multi_sped_v13":
        try:
            pagina_multi_sped_v13()
        except NameError:
            st.warning("Módulo v13 indisponível neste build.")
    elif pagina_ativa == "upload_massivo":
        pagina_upload_massivo()
    elif pagina_ativa == "analise_completa_v17":
        try:
            pagina_analise_completa_v17()
        except NameError:
            st.warning("Módulo v17 indisponível neste build.")
